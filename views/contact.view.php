  ...
  <script>
    ...
    function validateField(field) {
      ...
      if (field === 'email' && !input.value.includes('@')) {
        input.classList.add('error');
        errorMessageElement.innerText = 'Email skal være gyldig.';
        return false;
      }
    ...
    form.addEventListener('submit', function(e) {
      ...
      let valid = true;
      const fields = ['email', 'trainer', 'phone', 'reason'];
    ...
    function sendEmail() {
      ...
      const mailtoLink = `mailto:kbhmedhjaelp@gmail.com?subject=Kontakt din træner&body=Email: ${email}%0D%0ATræner: ${trainer}%0D%0ATelefon: ${phone}%0D%0AÅrsag: ${reason}`;
